...
class Image extends \Neos\Media\Domain\Model\Image implements \Doctrine\ORM\Proxy\Proxy
{
  ...
  'assetSourceIdentifier' => 'neos',
     ...
     * {@inheritDoc}
     */
    public function replaceVariant(\Neos\Media\Domain\Model\ImageVariant $variant)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'replaceVariant', [$variant]);

        return parent::replaceVariant($variant);
    }
     ...
     * {@inheritDoc}
     */
    public function getVariant(string $presetIdentifier, string $presetVariantName): ?\Neos\Media\Domain\Model\AssetVariantInterface
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVariant', [$presetIdentifier, $presetVariantName]);

        return parent::getVariant($presetIdentifier, $presetVariantName);
    }
