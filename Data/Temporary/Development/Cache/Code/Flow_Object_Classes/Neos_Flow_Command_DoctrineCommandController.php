...
class DoctrineCommandController extends DoctrineCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    protected function emitAfterDatabaseMigration() : void
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterDatabaseMigration'])) {
            parent::emitAfterDatabaseMigration();
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Command/DoctrineCommandController.php
#