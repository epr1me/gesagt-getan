...
class PluralsReader extends PluralsReader_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'rulesetsIndices' => 'array',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\I18n\Cldr\Reader\PluralsReader', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/I18n/Cldr/Reader/PluralsReader.php
#