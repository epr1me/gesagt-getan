...
class RedirectCommandController extends RedirectCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  4 => 'logger',
  5 => 'redirectExportService',
  6 => 'redirectImportService',
);
    }
}
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.RedirectHandler/Classes/Command/RedirectCommandController.php
#