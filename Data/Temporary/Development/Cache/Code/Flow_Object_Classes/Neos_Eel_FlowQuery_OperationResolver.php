...
class OperationResolver extends OperationResolver_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'finalOperationNames' => 'array',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Eel\FlowQuery\OperationResolver', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Eel/Classes/FlowQuery/OperationResolver.php
#