...
class PersistentResource extends PersistentResource_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface, \Neos\Flow\Persistence\Aspect\PersistenceMagicInterface {
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\ResourceManagement\PersistentResource', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/ResourceManagement/PersistentResource.php
#