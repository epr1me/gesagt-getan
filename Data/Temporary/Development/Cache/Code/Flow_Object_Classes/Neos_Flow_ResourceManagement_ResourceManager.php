...
class ResourceManager extends ResourceManager_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'initialized' => 'boolean',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\ResourceManagement\ResourceManager', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/ResourceManagement/ResourceManager.php
#