 ...
 */
class DefaultPropertyEditorPostprocessor_Original implements NodeTypePostprocessorInterface
{
 ...
 * @codeCoverageIgnore
 */
class DefaultPropertyEditorPostprocessor extends DefaultPropertyEditorPostprocessor_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Neos\NodeTypePostprocessor\DefaultPropertyEditorPostprocessor' === get_class($this)) {
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.Neos/Classes/NodeTypePostprocessor/DefaultPropertyEditorPostprocessor.php
#