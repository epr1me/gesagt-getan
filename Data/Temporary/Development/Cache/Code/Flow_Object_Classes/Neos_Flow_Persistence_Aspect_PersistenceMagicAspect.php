...
class PersistenceMagicAspect extends PersistenceMagicAspect_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'Persistence_Object_Identifier' => 'string',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\Persistence\Aspect\PersistenceMagicAspect', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Persistence/Aspect/PersistenceMagicAspect.php
#