...
class FileMonitor extends FileMonitor_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'directoriesAndFiles' => 'array',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\Monitor\FileMonitor', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Monitor/FileMonitor.php
#