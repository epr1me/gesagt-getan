...
class PropertyMapper extends PropertyMapper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'messages' => 'Neos\\Error\\Messages\\Result',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\Property\PropertyMapper', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Property/PropertyMapper.php
#