...
class FileSystemStorage extends FileSystemStorage_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'resourceRepository' => 'Neos\\Flow\\ResourceManagement\\ResourceRepository',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\ResourceManagement\Storage\FileSystemStorage', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/ResourceManagement/Storage/FileSystemStorage.php
#