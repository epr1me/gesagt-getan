 ...
 */
class RedirectImportService_Original
{
 ...
 * @codeCoverageIgnore
 */
class RedirectImportService extends RedirectImportService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\RedirectHandler\Service\RedirectImportService') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\RedirectHandler\Service\RedirectImportService', $this);
        if ('Neos\RedirectHandler\Service\RedirectImportService' === get_class($this)) {
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.RedirectHandler/Classes/Service/RedirectImportService.php
#