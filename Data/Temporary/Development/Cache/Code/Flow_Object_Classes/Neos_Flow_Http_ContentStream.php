...
class ContentStream extends ContentStream_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'logger' => 'Psr\\Log\\LoggerInterface',
    ...
    {
        $this->Flow_Proxy_LazyPropertyInjection('Neos.Flow:SystemLogger', 'Psr\Log\LoggerInterface', 'logger', '7223bbfeee720a0172f3e5ca41bf3d10', function() { return \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos.Flow:SystemLogger'); });
        $this->Flow_Injected_Properties = array (
  0 => 'logger',
);
    }
}
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Http/ContentStream.php
#