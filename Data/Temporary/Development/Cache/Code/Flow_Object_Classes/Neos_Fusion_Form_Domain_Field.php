 ...
 */
class Field_Original extends AbstractFormObject
{
 ...
 * @codeCoverageIgnore
 */
class Field extends Field_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if ('Neos\Fusion\Form\Domain\Field' === get_class($this)) {
  ...
  'form' => 'Neos\\Fusion\\Form\\Domain\\Form|null',
  'name' => 'string|null',
  'currentValue' => 'mixed',
  'targetValue' => 'mixed',
  'multiple' => 'boolean',
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.Fusion.Form/Classes/Domain/Field.php
#