...
class WritableFileSystemStorage extends WritableFileSystemStorage_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'resourceRepository' => 'Neos\\Flow\\ResourceManagement\\ResourceRepository',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\ResourceManagement\Storage\WritableFileSystemStorage', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/ResourceManagement/Storage/WritableFileSystemStorage.php
#