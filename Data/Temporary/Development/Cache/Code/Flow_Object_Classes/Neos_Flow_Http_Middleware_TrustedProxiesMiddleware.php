 ...
 */
class TrustedProxiesMiddleware_Original implements MiddlewareInterface
{
 ...
 * @codeCoverageIgnore
 */
class TrustedProxiesMiddleware extends TrustedProxiesMiddleware_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if ('Neos\Flow\Http\Middleware\TrustedProxiesMiddleware' === get_class($this)) {
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Http/Middleware/TrustedProxiesMiddleware.php
#