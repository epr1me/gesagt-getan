...
class RsaWalletServicePhp extends RsaWalletServicePhp_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'saveKeysOnShutdown' => 'boolean',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\Security\Cryptography\RsaWalletServicePhp', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Security/Cryptography/RsaWalletServicePhp.php
#