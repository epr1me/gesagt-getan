...
class NodeInfoHelper extends NodeInfoHelper_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'ignoredNodeTypeRole' => 'string',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->defaultBaseNodeType = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration('Settings', 'Neos.Neos.userInterface.navigateComponent.nodeTree.presets.default.baseNodeType');
  ...
  6 => 'contextFactory',
  7 => 'defaultBaseNodeType',
  8 => 'loadingDepth',
  9 => 'documentNodeTypeRole',
  10 => 'ignoredNodeTypeRole',
);
    }
}
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.Neos.Ui/Classes/Fusion/Helper/NodeInfoHelper.php
#