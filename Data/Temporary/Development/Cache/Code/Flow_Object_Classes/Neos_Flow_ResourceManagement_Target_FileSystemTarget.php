...
class FileSystemTarget extends FileSystemTarget_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'baseUriProvider' => 'Neos\\Flow\\Http\\BaseUriProvider',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\ResourceManagement\Target\FileSystemTarget', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/ResourceManagement/Target/FileSystemTarget.php
#