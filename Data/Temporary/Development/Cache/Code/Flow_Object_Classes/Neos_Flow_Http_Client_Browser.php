 ...
 * @api
 */
class Browser_Original implements ClientInterface
{
    /**
...
class Browser extends Browser_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        parent::__construct();
        if ('Neos\Flow\Http\Client\Browser' === get_class($this)) {
  ...
  'lastRequest' => 'Psr\\Http\\Message\\RequestInterface',
  'lastResponse' => 'Psr\\Http\\Message\\ResponseInterface',
  ...
  'contentStreamFactory' => 'Psr\\Http\\Message\\StreamFactoryInterface',
    ...
    {
        $this->setRequestEngine(new \Neos\Flow\Http\Client\CurlEngine());
  ...
  0 => 'requestEngine',
  1 => 'serverRequestFactory',
  2 => 'contentStreamFactory',
);
    }
}
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Http/Client/Browser.php
#