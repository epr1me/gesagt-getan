...
class RoutingCommandController extends RoutingCommandController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'serverRequestFactory' => 'Neos\\Http\\Factories\\ServerRequestFactory',
  ...
  'output' => 'Neos\\Flow\\Cli\\ConsoleOutput',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->serverRequestFactory = new \Neos\Http\Factories\ServerRequestFactory(\Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Psr\Http\Message\UriFactoryInterface'), \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration(\Neos\Flow\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'Neos.Flow.http.serverRequestDefaults.userAgent'), \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration(\Neos\Flow\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'Neos.Flow.http.serverRequestDefaults.scriptPath'), \Neos\Flow\Core\Bootstrap::$staticObjectManager->get(\Neos\Flow\Configuration\ConfigurationManager::class)->getConfiguration(\Neos\Flow\Configuration\ConfigurationManager::CONFIGURATION_TYPE_SETTINGS, 'Neos.Flow.http.serverRequestDefaults.protocolVersion'));
        $this->Flow_Injected_Properties = array (
  0 => 'commandManager',
  1 => 'objectManager',
  2 => 'configurationManager',
  3 => 'router',
  4 => 'serverRequestFactory',
);
    }
}
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Command/RoutingCommandController.php
#