...
class FormRuntime extends FormRuntime_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __construct()
    {
        ...
        if (!array_key_exists(2, $arguments)) $arguments[2] = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\Flow\Mvc\ActionResponse');
  ...
  'parentResponse' => 'Neos\\Flow\\Mvc\\ActionResponse',
  ...
  'renderCallbacks' => 'array<callable>',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Form\Core\Runtime\FormRuntime', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.Form/Classes/Core/Runtime/FormRuntime.php
#