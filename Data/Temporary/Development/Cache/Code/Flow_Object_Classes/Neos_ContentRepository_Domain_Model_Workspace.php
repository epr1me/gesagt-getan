...
class Workspace extends Workspace_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface, \Neos\Flow\Persistence\Aspect\PersistenceMagicInterface {
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\ContentRepository\Domain\Model\Workspace', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
     ...
     * @Flow\Signal
     */
    protected function emitBaseWorkspaceChanged(\Neos\ContentRepository\Domain\Model\Workspace $workspace, ?\Neos\ContentRepository\Domain\Model\Workspace $oldBaseWorkspace = NULL, ?\Neos\ContentRepository\Domain\Model\Workspace $newBaseWorkspace = NULL) : void
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBaseWorkspaceChanged'])) {
            parent::emitBaseWorkspaceChanged($workspace, $oldBaseWorkspace, $newBaseWorkspace);
     ...
     * @Flow\Signal
     */
    protected function emitBeforeNodePublishing(\Neos\ContentRepository\Domain\Model\NodeInterface $node, \Neos\ContentRepository\Domain\Model\Workspace $targetWorkspace) : void
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitBeforeNodePublishing'])) {
            parent::emitBeforeNodePublishing($node, $targetWorkspace);
     ...
     * @Flow\Signal
     */
    protected function emitAfterNodePublishing(\Neos\ContentRepository\Domain\Model\NodeInterface $node, \Neos\ContentRepository\Domain\Model\Workspace $targetWorkspace) : void
    {

        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitAfterNodePublishing'])) {
            parent::emitAfterNodePublishing($node, $targetWorkspace);
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.ContentRepository/Classes/Domain/Model/Workspace.php
#