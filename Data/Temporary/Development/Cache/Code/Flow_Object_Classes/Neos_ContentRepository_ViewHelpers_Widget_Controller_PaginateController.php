    ...
    protected function emitViewResolved(\Neos\Flow\Mvc\View\ViewInterface $view)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitViewResolved'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\ViewHelpers\Widget\Controller\PaginateController', 'emitViewResolved', $methodArguments);
                ...
                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitViewResolved']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    ...
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\ContentRepository\ViewHelpers\Widget\Controller\PaginateController', 'emitViewResolved', $methodArguments, NULL, $result);
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.ContentRepository/Classes/ViewHelpers/Widget/Controller/PaginateController.php
#