 ...
 * @internal
 */
class NodeMoveIntegrityCheckService_Original
{
 ...
 * @codeCoverageIgnore
 */
class NodeMoveIntegrityCheckService extends NodeMoveIntegrityCheckService_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    {
        if (get_class($this) === 'Neos\ContentRepository\Domain\Service\NodeMoveIntegrityCheckService') \Neos\Flow\Core\Bootstrap::$staticObjectManager->setInstance('Neos\ContentRepository\Domain\Service\NodeMoveIntegrityCheckService', $this);
        if ('Neos\ContentRepository\Domain\Service\NodeMoveIntegrityCheckService' === get_class($this)) {
  ...
  'contextFactory' => 'Neos\\ContentRepository\\Domain\\Service\\ContextFactoryInterface',
    ...
    private function Flow_Proxy_injectProperties()
    {
        ...
        $this->contentDimensionPresetSource = \Neos\Flow\Core\Bootstrap::$staticObjectManager->get('Neos\ContentRepository\Domain\Service\ContentDimensionPresetSourceInterface');
  ...
  0 => 'contentDimensionCombinator',
  1 => 'contentDimensionPresetSource',
  2 => 'contextFactory',
);
    }
}
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.ContentRepository/Classes/Domain/Service/NodeMoveIntegrityCheckService.php
#