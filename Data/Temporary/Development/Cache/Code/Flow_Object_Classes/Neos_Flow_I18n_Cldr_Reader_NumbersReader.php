...
class NumbersReader extends NumbersReader_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'localizedSymbols' => 'array',
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Flow\I18n\Cldr\Reader\NumbersReader', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/I18n/Cldr/Reader/NumbersReader.php
#