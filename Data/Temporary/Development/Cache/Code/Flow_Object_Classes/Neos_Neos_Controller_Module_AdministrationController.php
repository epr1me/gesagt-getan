...
class AdministrationController extends AdministrationController_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
    ...
    public function __wakeup()
    {
        ...
        $isClassProxy = array_search('Neos\Neos\Controller\Module\AdministrationController', $classParents) !== false && array_search('Doctrine\Persistence\Proxy', $classImplements) !== false;
    ...
    protected function emitViewResolved(\Neos\Flow\Mvc\View\ViewInterface $view)
    {
        ...
        if (isset($this->Flow_Aop_Proxy_methodIsInAdviceMode['emitViewResolved'])) {
            ...
            try {
                ...
                $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\AdministrationController', 'emitViewResolved', $methodArguments);
                ...
                if (isset($this->Flow_Aop_Proxy_targetMethodsAndGroupedAdvices['emitViewResolved']['Neos\Flow\Aop\Advice\AfterReturningAdvice'])) {
                    ...
                    $joinPoint = new \Neos\Flow\Aop\JoinPoint($this, 'Neos\Neos\Controller\Module\AdministrationController', 'emitViewResolved', $methodArguments, NULL, $result);
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Application/Neos.Neos/Classes/Controller/Module/AdministrationController.php
#