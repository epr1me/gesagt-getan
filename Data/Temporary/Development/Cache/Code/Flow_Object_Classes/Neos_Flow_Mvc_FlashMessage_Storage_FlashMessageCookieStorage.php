...
class FlashMessageCookieStorage_Original implements FlashMessageStorageInterface
{
...
class FlashMessageCookieStorage extends FlashMessageCookieStorage_Original implements \Neos\Flow\ObjectManagement\Proxy\ProxyInterface {
  ...
  'options' => 'array',
  'cookieName' => 'string Name of the FlashMessage cookie, defaults to self::DEFAULT_COOKIE_NAME',
  'flashMessageContainer' => 'Neos\\Flow\\Mvc\\FlashMessage\\FlashMessageContainer|null',
);
...
# PathAndFilename: /Applications/MAMP/htdocs/neos-example/Packages/Framework/Neos.Flow/Classes/Mvc/FlashMessage/Storage/FlashMessageCookieStorage.php
#