<?php 
class renderable_Neos_Form_Password_3e07828fec36ea4824abeda4873d88631dbe6536 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array15 = array (
);return $renderingContext->getVariableProvider()->getByPath('element', $array15);
};
$arguments13 = array();
$arguments13['property'] = NULL;
$arguments13['element'] = NULL;
$arguments13['property'] = 'passwordDescription';

$output12 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\Form\ViewHelpers\TranslateElementPropertyViewHelper::renderStatic($arguments13, $renderChildrenClosure14, $renderingContext)]);
...
$array9 = array();
$array10 = array (
);$array9['0'] = $renderingContext->getVariableProvider()->getByPath('element.properties.passwordDescription', $array10);
...
$arguments17['name'] = 'Neos.Form:Field';
...
$array24 = array (
);$arguments22['property'] = $renderingContext->getVariableProvider()->getByPath('element.identifier', $array24);
$array25 = array (
);$arguments22['id'] = $renderingContext->getVariableProvider()->getByPath('element.uniqueIdentifier', $array25);
$array26 = array (
);$arguments22['class'] = $renderingContext->getVariableProvider()->getByPath('element.properties.elementClassAttribute', $array26);
$array27 = array (
);$arguments22['errorClass'] = $renderingContext->getVariableProvider()->getByPath('element.properties.elementErrorClassAttribute', $array27);

$output21 .= Neos\FluidAdaptor\ViewHelpers\Form\PasswordViewHelper::renderStatic($arguments22, $renderChildrenClosure23, $renderingContext);
...
$array36 = array (
);return $renderingContext->getVariableProvider()->getByPath('element', $array36);
};
$arguments34 = array();
$arguments34['property'] = NULL;
$arguments34['element'] = NULL;
$arguments34['property'] = 'passwordDescription';

$output33 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\Form\ViewHelpers\TranslateElementPropertyViewHelper::renderStatic($arguments34, $renderChildrenClosure35, $renderingContext)]);
...
$array30 = array();
$array31 = array (
);$array30['0'] = $renderingContext->getVariableProvider()->getByPath('element.properties.passwordDescription', $array31);
