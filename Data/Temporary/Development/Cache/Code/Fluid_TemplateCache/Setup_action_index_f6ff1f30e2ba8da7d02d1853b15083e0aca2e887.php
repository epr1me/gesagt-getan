<?php 
class Setup_action_index_f6ff1f30e2ba8da7d02d1853b15083e0aca2e887 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments1['useMainRequest'] = false;
$arguments1['controller'] = 'Login';
$arguments1['action'] = 'logout';
$arguments1['class'] = 'btn pull-right logout btn-mini';

$output0 .= Neos\FluidAdaptor\ViewHelpers\Link\ActionViewHelper::renderStatic($arguments1, $renderChildrenClosure2, $renderingContext);
...
$array5 = array (
);return $renderingContext->getVariableProvider()->getByPath('form', $array5);
};
$arguments3 = array();
...
$arguments12['controller'] = 'Login';
$arguments12['action'] = 'logout';
$arguments12['class'] = 'btn pull-right logout btn-mini';

$output11 .= Neos\FluidAdaptor\ViewHelpers\Link\ActionViewHelper::renderStatic($arguments12, $renderChildrenClosure13, $renderingContext);
...
$array16 = array (
);return $renderingContext->getVariableProvider()->getByPath('form', $array16);
};
$arguments14 = array();
