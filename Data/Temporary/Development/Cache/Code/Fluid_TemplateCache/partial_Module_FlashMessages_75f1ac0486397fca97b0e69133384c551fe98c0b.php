<?php 
class partial_Module_FlashMessages_75f1ac0486397fca97b0e69133384c551fe98c0b extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array18 = array (
);return $renderingContext->getVariableProvider()->getByPath('flashMessage.severity', $array18);
};
$arguments16 = array();
$arguments16['value'] = NULL;
$arguments16['mode'] = 'upper';
$arguments16['mode'] = 'lower';

$output15 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\FluidAdaptor\ViewHelpers\Format\CaseViewHelper::renderStatic($arguments16, $renderChildrenClosure17, $renderingContext)]);
...
$output21 .= 'flashMessage.';
$array22 = array (
);
$output21 .= $renderingContext->getVariableProvider()->getByPath('flashMessage.code', $array22);
$arguments19['id'] = $output21;
$array23 = array (
);$arguments19['arguments'] = $renderingContext->getVariableProvider()->getByPath('flashMessage.arguments', $array23);
$array24 = array (
);$arguments19['value'] = $renderingContext->getVariableProvider()->getByPath('flashMessage', $array24);

$output15 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\Neos\ViewHelpers\Backend\TranslateViewHelper::renderStatic($arguments19, $renderChildrenClosure20, $renderingContext)]);
...
$array14 = array (
);$arguments12['each'] = $renderingContext->getVariableProvider()->getByPath('flashMessages', $array14);
$arguments12['as'] = 'flashMessage';
...
$array9 = array (
);return $renderingContext->getVariableProvider()->getByPath('flashMessages', $array9);
};
$arguments7 = array();
$arguments7['subject'] = NULL;
$renderChildrenClosure8 = ($arguments7['subject'] !== null) ? function() use ($arguments7) { return $arguments7['subject']; } : $renderChildrenClosure8;$array6['0'] = TYPO3Fluid\Fluid\ViewHelpers\CountViewHelper::renderStatic($arguments7, $renderChildrenClosure8, $renderingContext);
$array6['1'] = ' > 0';
...
$output0 .= Neos\FluidAdaptor\ViewHelpers\FlashMessagesViewHelper::renderStatic($arguments1, $renderChildrenClosure2, $renderingContext);
