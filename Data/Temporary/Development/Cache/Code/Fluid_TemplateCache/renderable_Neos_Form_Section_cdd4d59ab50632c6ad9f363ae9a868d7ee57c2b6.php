<?php 
class renderable_Neos_Form_Section_cdd4d59ab50632c6ad9f363ae9a868d7ee57c2b6 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('section.uniqueIdentifier', $array1)]);
...
$array4 = array();
$array5 = array (
);$array4['0'] = $renderingContext->getVariableProvider()->getByPath('section.properties.elementClassAttribute', $array5);
...
$output7 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('section.properties.elementClassAttribute', $array8)]);
...
$output17 .= 'forms.sections.';
$array18 = array (
);
$output17 .= $renderingContext->getVariableProvider()->getByPath('section.identifier', $array18);

$output17 .= '.label';
$arguments15['id'] = $output17;
$array19 = array (
);$arguments15['package'] = $renderingContext->getVariableProvider()->getByPath('section.renderingOptions.translationPackage', $array19);
$array20 = array (
);$arguments15['value'] = $renderingContext->getVariableProvider()->getByPath('section.label', $array20);

$output14 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\FluidAdaptor\ViewHelpers\TranslateViewHelper::renderStatic($arguments15, $renderChildrenClosure16, $renderingContext)]);
...
$array11 = array();
$array12 = array (
);$array11['0'] = $renderingContext->getVariableProvider()->getByPath('section.label', $array12);
...
$array27 = array (
);$arguments25['renderable'] = $renderingContext->getVariableProvider()->getByPath('element', $array27);

$output24 .= Neos\Form\ViewHelpers\RenderRenderableViewHelper::renderStatic($arguments25, $renderChildrenClosure26, $renderingContext);
...
$array23 = array (
);$arguments21['each'] = $renderingContext->getVariableProvider()->getByPath('section.elements', $array23);
