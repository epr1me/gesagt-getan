<?php 
class renderable_Neos_Form_HiddenField_c01c71e484e7f4851e118c2a3255edecaa921e3f extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$array2 = array (
);$arguments0['property'] = $renderingContext->getVariableProvider()->getByPath('element.identifier', $array2);
$array3 = array (
);$arguments0['id'] = $renderingContext->getVariableProvider()->getByPath('element.uniqueIdentifier', $array3);

return Neos\FluidAdaptor\ViewHelpers\Form\HiddenViewHelper::renderStatic($arguments0, $renderChildrenClosure1, $renderingContext);
}
