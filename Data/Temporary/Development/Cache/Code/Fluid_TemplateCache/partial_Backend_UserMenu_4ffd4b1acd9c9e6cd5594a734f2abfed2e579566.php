<?php 
class partial_Backend_UserMenu_4ffd4b1acd9c9e6cd5594a734f2abfed2e579566 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '
<div class="neos-button-group neos-user-menu" data-csrf-Token="';
...
$output0 .= '">
	<button class="neos-dropdown-toggle neos-button" data-neos-toggle="dropdown" href="#" title="';
...
$arguments3['source'] = 'Main';
$arguments3['package'] = NULL;
$arguments3['quantity'] = NULL;
$arguments3['locale'] = NULL;
$arguments3['id'] = 'userSettings.usermenu';
$arguments3['source'] = 'Modules';
$arguments3['value'] = 'User Menu';

$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\Neos\ViewHelpers\Backend\TranslateViewHelper::renderStatic($arguments3, $renderChildrenClosure4, $renderingContext)]);

$output0 .= '" data-neos-tooltip data-placement="left">
		<i class="fas fa-user"></i> ';
$array5 = array (
);
$output0 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('user.name.fullName', $array5)]);

$output0 .= ' <i class="fas fa-chevron-down"></i>
	</button>
...
$output11 .= '<i class="fas fa-sign-out-alt"></i> ';
// Rendering ViewHelper Neos\Neos\ViewHelpers\Backend\TranslateViewHelper
...
$arguments12['id'] = 'logout';
$arguments12['value'] = 'Logout';

$output11 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [Neos\Neos\ViewHelpers\Backend\TranslateViewHelper::renderStatic($arguments12, $renderChildrenClosure13, $renderingContext)]);
return $output11;
};
$arguments9 = array();
...
$arguments9['disabled'] = false;
$arguments9['form'] = NULL;
$arguments9['formaction'] = NULL;
$arguments9['formenctype'] = NULL;
$arguments9['formmethod'] = NULL;
$arguments9['formnovalidate'] = NULL;
$arguments9['formtarget'] = NULL;
$arguments9['type'] = 'submit';
...
$arguments9['value'] = 'logout';

$output8 .= Neos\FluidAdaptor\ViewHelpers\Form\ButtonViewHelper::renderStatic($arguments9, $renderChildrenClosure10, $renderingContext);
...
$arguments6['action'] = 'logout';

$output0 .= Neos\FluidAdaptor\ViewHelpers\FormViewHelper::renderStatic($arguments6, $renderChildrenClosure7, $renderingContext);
...
$arguments17['id'] = 'userSettings.label';
$arguments17['source'] = 'Modules';
$arguments17['value'] = 'User Settings';
...
$arguments14['path'] = NULL;
$arguments14['action'] = NULL;
$arguments14['arguments'] = array (
);
$arguments14['section'] = NULL;
$arguments14['format'] = NULL;
$arguments14['additionalParams'] = array (
);
$arguments14['addQueryString'] = false;
$arguments14['argumentsToBeExcludedFromQueryString'] = array (
);
$arguments14['path'] = 'user/usersettings';

$output0 .= Neos\Neos\ViewHelpers\Link\ModuleViewHelper::renderStatic($arguments14, $renderChildrenClosure15, $renderingContext);
